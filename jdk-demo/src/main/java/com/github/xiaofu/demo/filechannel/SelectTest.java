...
public class SelectTest
{
		...
		throws Exception
	{
		...
		SelectionKey sk1=ssc.register (selector, SelectionKey.OP_ACCEPT);
		SelectionKey sk2=ssc.register (Selector.open(), SelectionKey.OP_ACCEPT);
		System.out.println(sk1==sk2);
		sk1.cancel();
		System.out.println(sk1.isValid());
		while (true) {
