 ...
 * 
 */
package com.github.xiaofu.lucene.demo.facet;
...
public class TaxonomyIndex {
	...
	public void buildIndex() throws Exception {
		Directory directory = FSDirectory.open(Paths.get("facetIndex"));
		...
		Directory taxioDirectory = FSDirectory.open(Paths.get("taxioDir"));
    ...
    private void printDocs(TopDocs docs,IndexSearcher searcher)
    {
