...
public class CreateSpellCheckerIndex {
  ...
  public static void main(String[] args) throws IOException {
		 ...
		 * println("Usage: java lia.tools.SpellCheckerTest SpellCheckerIndexDir IndexDir IndexField"
		 * ); System.exit(1); }
		 */
    ...
    try {
      spell.indexDictionary(new LuceneDictionary(r, indexField),new IndexWriterConfig(),true);  //#C
    } finally {
      r.close();
    }
    dir.close();
