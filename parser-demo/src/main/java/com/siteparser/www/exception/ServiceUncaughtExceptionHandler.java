...
package com.siteparser.www.exception;
...
import com.siteparser.www.utils.ExitUtil;
...
public class ServiceUncaughtExceptionHandler implements UncaughtExceptionHandler {
  private static final Log LOG = LogFactory.getLog(ServiceUncaughtExceptionHandler.class);
